    ...
    return (
        ...
        >
            <div className=" px-5 py-12 h-fit"
                style={{ minHeight: "200px", backgroundColor: "rgba(245, 39, 145, 0.39)", color: "black" }}
            >
                <p className="mb-4 caveat text-2xl">Dear Friend,</p>

                <p className="caveat text-xl">
                ...
                <p className="caveat text-2xl text-right mt-6">
                    <p>Yours Lovely</p>
                    [Your Name]
                </p>
